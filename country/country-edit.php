                        ...
                        ?>
                                <form action="country-update.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="country_name" value="<?= $result['country_name'] ?>" required class="form-control" />
                                    </div>

                                    <div class="mb-3">
                                        <button type="submit" name="update_country" class="btn btn-primary">Update country</button>
                                    </div>
                                </form>
