            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="school-create.php" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="no_of_floor" required class="form-control" />
                            </div>
                            <!-- <div class="mb-3">
                                <label for="">parent</label>
                                <input type="text" name="parent_id" required class="form-control" />
                            </div> -->
