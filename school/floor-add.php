            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="floor-create.php" method="POST">


                            <div class="mb-3">
                                <label for="">Enter floor name</label>
                                <input type="text" name="name" required class="form-control" />
                            </div>
                            <div class="mb-3">
                                <label for="">Number of rooms</label>
                                <input type="text" name="no_of_room" required class="form-control" />
                            </div>
                            <div class="mb-3">
                                <button type="submit" name="save_floor" class="btn btn-primary">Save floor</button>
                            </div>
                            <div>
                                <label>school</label>
